...
/**
 * Eccezione lanciata quando il controllo sul nome di un'azienda fallisce poiché questo
...
public class NomeAziendaNonValidoException extends Exception {
  ...
  private static final String messaggioDefault = "Nome azienda non valido";
