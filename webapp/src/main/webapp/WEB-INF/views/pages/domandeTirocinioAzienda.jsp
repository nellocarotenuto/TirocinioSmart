...
<spring:message var="voceMenu" scope="request" code="vmenu.domandeTirocinioAzienda.titolo" />
      ...
      <div class="card single-row-header">
        <div class="card-content">
          <span class="card-title">
            <spring:message code="pagina.domandeTirocinioAzienda.titolo" />
          </span>
        </div>
      </div>
      <jsp:include page="/WEB-INF/views/lists/domandeTirocinioAzienda.jsp" />
    </div>
  </div>
</main>
